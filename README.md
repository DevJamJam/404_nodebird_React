...
####  [리액트 & 넥스트 & 리덕스 & 리덕스사가 & 익스프레스 & sequelize 사용]

####  Next & React 사용 경험 및 숙련도 향상 및 SSR 구현 경험을 위해 작업 
####  ORM(sequelize)사용하여 MYSQL 작업 
####  Node사용 서버 구현 
####  AWS배포 ( S3, Lambda, EC2 ) 
####  현재 해당 포트폴리오는 배포되어 있지 않습니다. (차후 추가 구축 후 배포예정) 
...
![Badge](https://img.shields.io/badge/Redux_Saga-999999?style=flat&logo=Redux-Saga&logoColor=white)

#### Back : 
![Badge](https://img.shields.io/badge/Node.js-339933?style=flat&logo=Node.js&logoColor=white)
![Badge](https://img.shields.io/badge/AWS-232F3E?style=flat&logo=Amazon-AWS&logoColor=white)
![Badge](https://img.shields.io/badge/Sequelize-52B0E7?style=flat&logo=Sequelize&logoColor=white)
